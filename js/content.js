...
window.SITE = {
  ...
  featured: [
    ...
    {
      id: 'praecept', idx: '03', name: 'Praecept',
    ...
    {
      id: 'cascade', idx: '05', name: 'Cascade Operator',
    ...
    {
      id: 'safelink', idx: '06', name: 'SafeLink',
    ...
    {
      id: 'tripwire', idx: '07', name: 'Tripwire', status: 'in-progress',
